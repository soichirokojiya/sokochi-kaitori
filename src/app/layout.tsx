...
export const metadata: Metadata = {
  ...
  description:
    "底地の共有持分専門の底地ドットコム。売却・買取のご相談はお任せください。他の共有者の同意不要で、あなたの持分だけ売却できます。最短当日買取・上限価格なし・仲介手数料0円。相続トラブルや複雑な権利関係もスムーズに解決。全国対応・秘密厳守。まずは無料査定からお気軽にご相談ください。",
  ...
  verification: {
    google: "vSdmVfwNggFWqhcvUZcvwn_OZODGCdFaGQl4EWhSQZU",
  },
};
